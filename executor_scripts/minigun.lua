...
GENERATED PATCH: 1
	...
	TARGET: game:GetService("Players").OverZuka.Backpack.MINIGUN.Setting["1"]
--]]

local targetModule = require(game:GetService("Players").OverZuka.Backpack.MINIGUN.Setting["1"])
