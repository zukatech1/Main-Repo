...
GENERATED PATCH: 1
	...
	TARGET: game:GetService("Players")["8gats"].Backpack["BounceUMP-45"].Setting["1"]
--]]

local targetModule = require(game:GetService("Players")["8gats"].Backpack["BounceUMP-45"].Setting["1"])
...
targetModule.Ricochet = 999
targetModule.SuperRicochet = true
